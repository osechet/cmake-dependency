This is a simple project to test the behavior of cmake's find_dependency command with and without conan package. It is related to https://github.com/bincrafters/conan-gtest/pull/23.
